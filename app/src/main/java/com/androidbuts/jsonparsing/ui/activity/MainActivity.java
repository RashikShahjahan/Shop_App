    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Snackbar.make(parentView, productsList.get(position).getTitle() + " => " +productsList.get(position).getDescription()+" => " + productsList.get(position).getImage(), Snackbar.LENGTH_LONG).show();
            }
        });
                    ...
                    call.enqueue(new Callback<ProductList>() {
                        ...
                        public void onResponse(Call<ProductList> call, Response<ProductList> response) {
                            ...
                            if(response.isSuccessful()) {
                                 ...
                                 */
                                adapter = new MyContactAdapter(MainActivity.this, productsList);
